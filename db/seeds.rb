...
# --- User ---
user = User.new({ 'email' => 'user@example.com', 'reset_password_token' => nil, 'reset_password_sent_at' => nil,
                  'remember_created_at' => nil })
user.password = 'password'
user.save

# --- Challenge ---
challenge1 = Challenge.create!({ 'title' => 'The Riddle of the Sphinx',
...
challenge2 = Challenge.create!({ 'title' => 'The Enigma Machine',
...
challenge3 = Challenge.create!({ 'title' => 'The Gordian Knot',
...
challenge4 = Challenge.create!({ 'title' => 'The Zodiac 340 Cipher',
...
challenge5 = Challenge.create!({ 'title' => 'The Rosetta Stone',
...
# --- Chat ---
Chat.create!({ 'user_id' => user.id, 'challenge_id' => challenge1.id })
Chat.create!({ 'user_id' => user.id, 'challenge_id' => challenge2.id })
Chat.create!({ 'user_id' => user.id, 'challenge_id' => challenge3.id })
Chat.create!({ 'user_id' => user.id, 'challenge_id' => challenge4.id })
Chat.create!({ 'user_id' => user.id, 'challenge_id' => challenge5.id })
